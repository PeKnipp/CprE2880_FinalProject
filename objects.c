...
//        }
    ...
    scan(0, SONAR);
    angle =
            (objects[smallestIndex].angle_origin + objects[smallestIndex].center); // Get the angle of the object with smallest width
...
//                        distance = measurement[i];
        ...
        else
        {
            ...
            if (start_angle != -1 && check1 == 1 && check2 == 1 && check3 == 1)
            {
                object_num += 1;
                numObjects++;
                ...
                objects[object_num].center = (end_angle - start_angle) / 2.0;
